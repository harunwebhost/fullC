...
<?php 
		...
		if($lead_status!="Free trail"){
			...
			$sql_update_lead="UPDATE crm_leads SET lead_status='$lead_status', lead_name='$lead_name',lead_email='$lead_email',lead_mobile='$lead_mobile', lead_city='$lead_city' WHERE lead_id='$lead_id'";
