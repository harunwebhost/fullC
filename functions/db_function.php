                                            ...
                                            <td class="center">
                                                <?php
                                                    ...
                                                    <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu pull-right" role="menu">
                                                                <?php // 20-08-2016 changes?>
                                                                    <li><a href="lead_log.php?lead_history_id=<?php echo $fetch_lead['lead_id'];?>">History</a>
                                                                    </li>
...
<!--  get the History of leads -->
<!-- 20-08-2016 -->

<?php 


function log_history($user_type,$selected_lead){
              
      $label="History";
      $sql_lead="SELECT * FROM crm_leads_log crmlog, crm_leads leads, crm_employer emp
			WHERE 
			crmlog.lead_id=leads.lead_id
			AND
			emp.emp_id=leads.emp_id
			AND
			crmlog.lead_id='$selected_lead' 
      ";
                    ...
                    ?>
                                        ...
                                        <tr class="odd gradeX">
                                         <!--<td><input type="checkbox"></td>-->
                                            ...
                                            <td class="center"><?php echo $fetch_lead['contacted_date'];?></td>
