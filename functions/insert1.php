...
require_once('db_function.php');
    ...
    if($action=="update"){
     ...
     $values=rtrim($values,',');
       $sql = "update $table SET $values WHERE  $primary_key=$update_key";
    }else{
...
if(sql_fetch_num_rows($run_dublicate)==0) 
{
page_redirection('../employees/index.php',"Entered Mobile Number is Exits");
}else
{
...
page_redirection('../employees/index.php',"Record is Inserted");
}
} else {
