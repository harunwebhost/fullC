            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                         <li><a href="../functions/password_update.php"><i class="fa fa-key" aria-hidden="true"></i> Change Password</a></li>
 ...
 <div class="navbar-default sidebar" role="navigation">
                ...
                <li>
                      ...
                      <li>
                        ...
                        <li><a href="../functions/logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Logout</a></li> 
                           <li><a href="../functions/logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Change Password</a></li> 
